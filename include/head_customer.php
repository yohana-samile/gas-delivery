<?php
   session_start();
   $firstname =  $_SESSION['customer_data']['firstname'];
   $surname = $_SESSION['customer_data']['surname'];
   $_SESSION['customer_data']['phone_no'];
   if(!isset ($_SESSION['customer_data']['phone_no'])){
                  ...
                  <li class = "nav-item">
                     <div class="container">
                        <div class="row">
                           <div class="col-md-12">
                              <div class="modal fade" id="mymodal">
                                 <div class="modal-dialog">
                                    <div class="modal-content">
                                       <div class="modal-header">
                                          <h2 class="modal-title text-dark">you can contact us</h2>
                                          <button class="btn btn-default" data-dismiss="modal">&times;</button>
                                       </div>
                                       <div class="modal-body">
                                          <form action="message_action.php" method="post">
                                             <?php
                                                $user = $_SESSION['customer_data']['customer_id'];
                                             ?>
                                             <div class="form-group" hidden>
                                                <input value="<?php echo $user; ?>" name="customer_id" class="form-control">
                                             </div>
                                             <div class="form-group">
                                                <textarea placeholder="write your message" name="massege" class="form-control"></textarea>
                                             </div>
                                             <div class="form-group">
                                                <input type="submit" name="submit" value="send message" class="form-control bg-primary text-white">
                                             </div>
                                          </form>
                                       </div>
                                       <div class="modal-footer">
                           ...
                           <p class = "nav-link" data-toggle="modal" data-target="#mymodal" style="cursor:pointer">contact</p>
                        </div>
                     </div>
                  </li>
